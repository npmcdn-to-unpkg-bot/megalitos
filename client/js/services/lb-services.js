  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Role.user() instead.
        "::get::role::user": {
          url: urlBase + "/roles/:id/user",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Megalitos.lugares() instead.
        "prototype$__get__lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "GET"
        },

        // INTERNAL. Use Megalitos.lugares.create() instead.
        "prototype$__create__lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.lugares.update() instead.
        "prototype$__update__lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "PUT"
        },

        // INTERNAL. Use Megalitos.lugares.destroy() instead.
        "prototype$__destroy__lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "DELETE"
        },

        // INTERNAL. Use Megalitos.coordenadas() instead.
        "prototype$__get__coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "GET"
        },

        // INTERNAL. Use Megalitos.coordenadas.create() instead.
        "prototype$__create__coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.coordenadas.update() instead.
        "prototype$__update__coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "PUT"
        },

        // INTERNAL. Use Megalitos.coordenadas.destroy() instead.
        "prototype$__destroy__coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "DELETE"
        },

        // INTERNAL. Use Megalitos.imagenes.findById() instead.
        "prototype$__findById__imagenes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/megalitos/:id/imagenes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Megalitos.imagenes.destroyById() instead.
        ...
        // INTERNAL. Use Megalitos.imagenes.updateById() instead.
        ...
        // INTERNAL. Use Megalitos.imagenes() instead.
        "prototype$__get__imagenes": {
          isArray: true,
          url: urlBase + "/megalitos/:id/imagenes",
          method: "GET"
        },

        // INTERNAL. Use Megalitos.imagenes.create() instead.
        "prototype$__create__imagenes": {
          url: urlBase + "/megalitos/:id/imagenes",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.imagenes.destroyAll() instead.
        "prototype$__delete__imagenes": {
          url: urlBase + "/megalitos/:id/imagenes",
          method: "DELETE"
        },

        // INTERNAL. Use Megalitos.imagenes.count() instead.
        "prototype$__count__imagenes": {
          url: urlBase + "/megalitos/:id/imagenes/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Lugares.megalitos() instead.
        "::get::lugares::megalitos": {
          url: urlBase + "/lugares/:id/megalitos",
          method: "GET"
        },

        // INTERNAL. Use Coordenadas.megalitos() instead.
        "::get::coordenadas::megalitos": {
          url: urlBase + "/coordenadas/:id/megalitos",
          method: "GET"
        },

        // INTERNAL. Use Imagenes.megalitos() instead.
        "::get::imagenes::megalitos": {
          url: urlBase + "/imagenes/:id/megalitos",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Megalitos.lugares
     * @header lbServices.Megalitos.lugares
     * @object
     * @description
     *
     * The object `Megalitos.lugares` groups methods
     * manipulating `Lugares` instances related to `Megalitos`.
     *
     * Call {@link lbServices.Megalitos#lugares Megalitos.lugares()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Fetches hasOne relation lugares.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         */
        R.lugares = function() {
          var TargetResource = $injector.get("Lugares");
          var action = TargetResource["::get::megalitos::lugares"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.lugares#create
         * @methodOf lbServices.Megalitos.lugares
         *
         * @description
         *
         * Creates a new instance in lugares of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.lugares.create = function() {
          var TargetResource = $injector.get("Lugares");
          var action = TargetResource["::create::megalitos::lugares"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.lugares#createMany
         * @methodOf lbServices.Megalitos.lugares
         *
         * @description
         *
         ...
         * </em>
         */
        R.lugares.createMany = function() {
          var TargetResource = $injector.get("Lugares");
          var action = TargetResource["::createMany::megalitos::lugares"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.lugares#destroy
         * @methodOf lbServices.Megalitos.lugares
         *
         * @description
         *
         * Deletes lugares of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.lugares.destroy = function() {
          var TargetResource = $injector.get("Lugares");
          var action = TargetResource["::destroy::megalitos::lugares"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.lugares#update
         * @methodOf lbServices.Megalitos.lugares
         *
         * @description
         *
         * Update lugares of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.lugares.update = function() {
          var TargetResource = $injector.get("Lugares");
          var action = TargetResource["::update::megalitos::lugares"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Megalitos.coordenadas
     * @header lbServices.Megalitos.coordenadas
     * @object
     * @description
     *
     * The object `Megalitos.coordenadas` groups methods
     * manipulating `Coordenadas` instances related to `Megalitos`.
     *
     * Call {@link lbServices.Megalitos#coordenadas Megalitos.coordenadas()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Fetches hasOne relation coordenadas.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Coordenadas` object.)
         * </em>
         */
        R.coordenadas = function() {
          var TargetResource = $injector.get("Coordenadas");
          var action = TargetResource["::get::megalitos::coordenadas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.coordenadas#create
         * @methodOf lbServices.Megalitos.coordenadas
         *
         * @description
         *
         * Creates a new instance in coordenadas of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.coordenadas.create = function() {
          var TargetResource = $injector.get("Coordenadas");
          var action = TargetResource["::create::megalitos::coordenadas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.coordenadas#createMany
         * @methodOf lbServices.Megalitos.coordenadas
         *
         * @description
         *
         ...
         * </em>
         */
        R.coordenadas.createMany = function() {
          var TargetResource = $injector.get("Coordenadas");
          var action = TargetResource["::createMany::megalitos::coordenadas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.coordenadas#destroy
         * @methodOf lbServices.Megalitos.coordenadas
         *
         * @description
         *
         * Deletes coordenadas of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.coordenadas.destroy = function() {
          var TargetResource = $injector.get("Coordenadas");
          var action = TargetResource["::destroy::megalitos::coordenadas"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.coordenadas#update
         * @methodOf lbServices.Megalitos.coordenadas
         *
         * @description
         *
         * Update coordenadas of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.coordenadas.update = function() {
          var TargetResource = $injector.get("Coordenadas");
          var action = TargetResource["::update::megalitos::coordenadas"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Megalitos.imagenes
     * @header lbServices.Megalitos.imagenes
     * @object
     * @description
     *
     * The object `Megalitos.imagenes` groups methods
     * manipulating `Imagenes` instances related to `Megalitos`.
     *
     * Call {@link lbServices.Megalitos#imagenes Megalitos.imagenes()}
     * to query all related instances.
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Imagenes` object.)
         * </em>
         */
        R.imagenes = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::get::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#count
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
         * Counts imagenes of megalitos.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.imagenes.count = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::count::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#create
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
        ...
        R.imagenes.create = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::create::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#createMany
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
        ...
        R.imagenes.createMany = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::createMany::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#destroyAll
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
        ...
        R.imagenes.destroyAll = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::delete::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#destroyById
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
        ...
        R.imagenes.destroyById = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::destroyById::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#findById
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
        ...
        R.imagenes.findById = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::findById::megalitos::imagenes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Megalitos.imagenes#updateById
         * @methodOf lbServices.Megalitos.imagenes
         *
         * @description
         *
        ...
        R.imagenes.updateById = function() {
          var TargetResource = $injector.get("Imagenes");
          var action = TargetResource["::updateById::megalitos::imagenes"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Megalitos.lugares() instead.
        "::get::megalitos::lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "GET"
        },

        // INTERNAL. Use Megalitos.lugares.create() instead.
        "::create::megalitos::lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.lugares.createMany() instead.
        "::createMany::megalitos::lugares": {
          isArray: true,
          url: urlBase + "/megalitos/:id/lugares",
          method: "POST"
        },
        ...
        // INTERNAL. Use Megalitos.lugares.update() instead.
        "::update::megalitos::lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "PUT"
        },

        // INTERNAL. Use Megalitos.lugares.destroy() instead.
        "::destroy::megalitos::lugares": {
          url: urlBase + "/megalitos/:id/lugares",
          method: "DELETE"
        },
      }
    ...
    */
    R.modelName = "Lugares";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Lugares#megalitos
         * @methodOf lbServices.Lugares
         *
         * @description
         *
        ...
        R.megalitos = function() {
          var TargetResource = $injector.get("Megalitos");
          var action = TargetResource["::get::lugares::megalitos"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Coordenadas
 * @header lbServices.Coordenadas
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Coordenadas` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#create
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         */
        "create": {
          url: urlBase + "/coordenadas",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#createMany
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#upsert
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#exists
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/coordenadas/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#findById
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/coordenadas/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#find
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#findOne
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/coordenadas/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#updateAll
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/coordenadas/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#deleteById
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#count
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/coordenadas/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#prototype$updateAttributes
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#createChangeStream
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/coordenadas/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.coordenadas() instead.
        "::get::megalitos::coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "GET"
        },

        // INTERNAL. Use Megalitos.coordenadas.create() instead.
        "::create::megalitos::coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.coordenadas.createMany() instead.
        "::createMany::megalitos::coordenadas": {
          isArray: true,
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "POST"
        },
        ...
        // INTERNAL. Use Megalitos.coordenadas.update() instead.
        "::update::megalitos::coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "PUT"
        },

        // INTERNAL. Use Megalitos.coordenadas.destroy() instead.
        "::destroy::megalitos::coordenadas": {
          url: urlBase + "/megalitos/:id/coordenadas",
          method: "DELETE"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#updateOrCreate
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#update
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#destroyById
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#removeById
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Coordenadas#modelName
    * @propertyOf lbServices.Coordenadas
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Coordenadas`.
    */
    R.modelName = "Coordenadas";


        /**
         * @ngdoc method
         * @name lbServices.Coordenadas#megalitos
         * @methodOf lbServices.Coordenadas
         *
         * @description
         *
        ...
        R.megalitos = function() {
          var TargetResource = $injector.get("Megalitos");
          var action = TargetResource["::get::coordenadas::megalitos"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Imagenes
 * @header lbServices.Imagenes
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Imagenes` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#create
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#createMany
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#upsert
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#exists
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#findById
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#findOne
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#updateAll
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#deleteById
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#count
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#prototype$updateAttributes
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#createChangeStream
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        // INTERNAL. Use Megalitos.imagenes.destroyById() instead.
        "::destroyById::megalitos::imagenes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/megalitos/:id/imagenes/:fk",
        ...
        // INTERNAL. Use Megalitos.imagenes.create() instead.
        "::create::megalitos::imagenes": {
          url: urlBase + "/megalitos/:id/imagenes",
          method: "POST"
        },

        // INTERNAL. Use Megalitos.imagenes.createMany() instead.
        "::createMany::megalitos::imagenes": {
          isArray: true,
          url: urlBase + "/megalitos/:id/imagenes",
          method: "POST"
        },
        ...
        // INTERNAL. Use Megalitos.imagenes.destroyAll() instead.
        "::delete::megalitos::imagenes": {
          url: urlBase + "/megalitos/:id/imagenes",
          method: "DELETE"
        },

        // INTERNAL. Use Megalitos.imagenes.count() instead.
        "::count::megalitos::imagenes": {
          url: urlBase + "/megalitos/:id/imagenes/count",
          method: "GET"
        },
      }
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#updateOrCreate
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#update
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#destroyById
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Imagenes#removeById
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Imagenes#modelName
    * @propertyOf lbServices.Imagenes
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Imagenes`.
    */
    R.modelName = "Imagenes";


        /**
         * @ngdoc method
         * @name lbServices.Imagenes#megalitos
         * @methodOf lbServices.Imagenes
         *
         * @description
         *
        ...
        R.megalitos = function() {
          var TargetResource = $injector.get("Megalitos");
          var action = TargetResource["::get::imagenes::megalitos"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Role";
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::role::user"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
