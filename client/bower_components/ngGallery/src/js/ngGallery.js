(function () {
    ...
    function ngGallery($document, $timeout, $q, $templateCache) {
        ...
        $templateCache.put(template_url,
            ...
            '<a href="{{getImageDownloadSrc()}}" target="_blank" ng-show="showImageDownloadButton()" ng-click="openWindow()" class="download-image"><i class="fa fa-download"></i></a>' +
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.openWindow=function(){
                    window.open(scope.images[scope.index].downloadSrc, '_blank');
